...
def parse_command_line():
    ...
    parser.add_argument('-d', '--date', metavar = ('month', 'day', 'year'), nargs = 3, action = 'store', help = 'formatted date (i.e. 03 28 1998)')
    parser.add_argument('-s', '--surprise', action = 'store_true', help = 'select a random date for a surprise image')
    parser.add_argument('-k', '--api_key', metavar = 'API_KEY', action = 'store', type = str, default = '', help = 'NASA developer key')
...
def save_image(d, image):
    ...
    """    
    os.chdir("/Users/julien.matuszak/Repos/python/Python Scripting Academy/Python Scripting Academy Unit 3/final_project/")
    if "images" not in os.listdir("/Users/julien.matuszak/Repos/python/Python Scripting Academy/Python Scripting Academy Unit 3/final_project/"):
        os.mkdir("images")
    os.chdir("/Users/julien.matuszak/Repos/python/Python Scripting Academy/Python Scripting Academy Unit 3/final_project/images/")
    if str(d.year) not in os.listdir("/Users/julien.matuszak/Repos/python/Python Scripting Academy/Python Scripting Academy Unit 3/final_project/images/"):
        os.mkdir(str(d.year))
    os.chdir("/Users/julien.matuszak/Repos/python/Python Scripting Academy/Python Scripting Academy Unit 3/final_project/images/"+str(d.year))
    if str(d.month) not in os.listdir("/Users/julien.matuszak/Repos/python/Python Scripting Academy/Python Scripting Academy Unit 3/final_project/images/"+str(d.year)):
        os.mkdir(str(d.month))
    os.chdir("/Users/julien.matuszak/Repos/python/Python Scripting Academy/Python Scripting Academy Unit 3/final_project/images/"+str(d.year)+"/"+str(d.month))
    if str(d)+".jpg" not in "/Users/julien.matuszak/Repos/python/Python Scripting Academy/Python Scripting Academy Unit 3/final_project/images/"+str(d.year)+"/"+str(d.month):
        with open("/Users/julien.matuszak/Repos/python/Python Scripting Academy/Python Scripting Academy Unit 3/final_project/images/"+str(d.year)+"/"+str(d.month)+"/"+str(d)+".jpg", 'wb') as f:
            f.write(image)
    return "/Users/julien.matuszak/Repos/python/Python Scripting Academy/Python Scripting Academy Unit 3/final_project/images/"+str(d.year)+"/"+str(d.month)+"/"+str(d)+".jpg"               
def request(url):
    """
...
%%bash
python3 apod.py -d 7 4 2004

%%bash
python3 apod.py -s -v

# DELETES IMAGES and Folders
%cd /Users/julien.matuszak/Repos/python/Python Scripting Academy/Python Scripting Academy Unit 3/final_project
# Remove any folder under final_project
import os
import shutil
